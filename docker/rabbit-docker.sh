...
# docker run -d --name rabbitForLocalPurposeOnWs \
#   -e RABBITMQ_DEFAULT_USER=hypernode \
#   -e RABBITMQ_DEFAULT_PASS=hypernode \
#   -e RABBITMQ_PLUGINS_ENABLE=rabbitmq_web_mqtt \
#   -p 5672:5672 \
#   -p 15672:15672 \
#   -p 15675:15675 \
