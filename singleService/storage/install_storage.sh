...
echo "Welcome to additional storage service installation process"
...
export RMQ=${AMQP_URL}
export PROCESS_NAME=storage-${PROCESS_NAME}
export DB_NAME=database-for-${PROCESS_NAME}
export DATABASE_URI=mongodb://${DB_NAME}:27017/storage-service
