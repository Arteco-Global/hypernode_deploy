...
echo "Welcome to additional event service installation process"
...
export RMQ=${AMQP_URL}
export PROCESS_NAME=event-${PROCESS_NAME}
export DB_NAME=database-for-${PROCESS_NAME}
export DATABASE_URI=mongodb://${DB_NAME}:27017/event-service
